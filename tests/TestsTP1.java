...
import clases.operatoria.OperatoriaBancaria;
public class TestsTP1{
	
	@Before
	public void CrearOperatoria() {
		OperatoriaBancaria operatoria = new OperatoriaBancaria();
		Domicilio domicilio = new Domicilio("Navarro",117,1608,"Devoto","Buenos Aires");
	}
	...
	*/
	...
	public void CrearDomicilioSinCalle() {
		Domicilio domicilioInvalido = new Domicilio("",117,1608,"Devoto","Buenos Aires");
	}

	@Test(expected = Error.class)
	public void CrearDomicilioInvalido() {
		Domicilio domicilioInvalido = new Domicilio("Navarro",-117,1608,"Devoto","Buenos Aires");
	}
	...
	*/
	...
	public void CrearPersonaFisicaValida() {
		...
		Cliente personaFisicaValida = operatoria.altaPersonaFisica("Lucas Martinez", 1234567890123,
				domicilio, 45011234, "DNI", 37340483, "Casado", "Ingeniero", "Delfina Nevado");
		
		Assert.assertNotNull(personaFisicaValida);
		Assert.assertEquals(37340483, personaFisicaValida.getNumeroDeDocumento());
	...
	public void CrearPersonaFisicaInvalidaNombre() {
		...
		Cliente personaFisicaInvalida = operatoria.altaPersonaFisica(" ", 1234567890123,
				domicilio, 45011234, "DNI",37340483, "Casado", "Ingeniero", "Delfina Nevado");
	...
	public void CrearPersonaFisicaInvalidaDomicilio() {
		...
		Cliente personaFisicaInvalida = operatoria.altaPersonaFisica("Lucas Martinez", 1234567890123, "",
				"DNI", 37340483, "Casado", "Ingeniero", 45011234,
				"Delfina Nevado");
	...
	public void CrearPersonaFisicaInvalidaCUIT() {
		...
		Cliente personaFisicaInvalida = operatoria.altaPersonaFisica("Lucas Martinez", -123456,
				domicilio, 45011234, "DNI", 37340483, "Casado", "Ingeniero", "Delfina Nevado");
	...
	public void CrearPersonaFisicaInvalidaTipoDocumento() {
		...
		Cliente personaFisicaInvalida =  operatoria.altaPeraltaPersonaFisicasonaFisica("Lucas Martinez", 			1234567890123,domicilio, 45011234,"",37340483, "Casado", "Ingeniero", "Delfina Nevado");
	...
	public void CrearPersonaFisicaInvalidaCUITRepetido() {
		...
		Cliente personaFisicaInvalida1 = operatoria.altaPersonaFisica("Lucas Martinez", 1234567890123,
				domicilio, 45011234, "DNI", 37340483, "Casado", "Ingeniero", "Delfina Nevado");

		Cliente personaFisicaInvalida2 = operatoria.altaPersonaFisica("Delfina Nevado", 1234567890123,
				domicilio, 45011234, "DNI", 37171103, "Casado", "Ingeniero", "Lucas Martinez");
		
		Assert.assertFalse(personaFisicaInvalida1.getCuit() == personaFisicaInvalida2.getCuit());
	}
	
	@Test 
	public void CrearPersonaFisicaYaCreada() {

		Cliente clienteInvalido1 = operatoria.altaPersonaFisica("Lucas Martinez", 1234567890123,
				domicilio, 45011234, "DNI",	37340483, "Casado", "Ingeniero", "Delfina Nevado");

		Cliente clienteInvalido2 = operatoria.altaPersonaFisica("Lucas Martinez", 1234567890123,
				domicilio, 45011234, "DNI",	37171103, "Casado", "Ingeniero", "Lucas Martinez");
		
		/*comprobamos que no se instancien dos objetos iguales (clienteInvalido2.getNumeroDeDocumento() deberia devolver null)*/
		Assert.assertFlase(clienteInvalido1.getNumeroDeDocumento(),clienteInvalido2.getNumeroDeDocumento);
	...
	*/
	...
	public void CrearPersonaJuridicaValida() {
		...
		Cliente personaJuridicaValido = operatoria.altaPersonaJuridica("Lucas Martinez", 1234567890123,
	...
	public void CrearPersonaJuridicaInvalidaCUIT() {
		...
		Cliente personaJuridicaInvalido = operatoria.altaPersonaJuridica("Lucas Martinez", -1234567890123,
				domicilio, 45011234, 16042014);
	...
	public void CrearPersonaJuridicaInvalidaNombre() {
		...
		Cliente personaJuridicaInvalido = operatoria.altaPersonaJuridica("", 1234567890123,
				domicilio, 45011234, 16042014);
	...
	*/
	...
	public void darDeBajaCliente(){
		...
		Cliente delfina = operatoria.altaPersonaFisica("Delfina Nevado", 1234567890123,
				domicilio, 45011234, "DNI",	37171103, "Casado", "Ingeniero", "Lucas Martinez");
	...
	*/
	...
	public void aperturaCajaDeAhorroValida(){
		...
		Cliente lucas = operatoria.altaPersonaFisica("Lucas Martinez", 1234567890123,
				domicilio, 45011234, "DNI",	37340483, "Casado", "Ingeniero", "Delfina Nevado");
	...
	public void aperturaCajaDeAhorroInvalidaPersonaJuridica(){
		...
		Cliente lucas = operatoria.altaPersonaJuridica("Lucas Martinez", 1234567890123,
				domicilio, 45011234, 16042014);
